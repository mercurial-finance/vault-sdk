...
impl StrategyHandler for PortFinanceWithoutLMHandler {
    fn get_withdraw2_remaining_accounts(
        ...
        withdraw2_remaining_accounts.append(&mut port_remaining_accounts);
