...
import { PublicKey, TransactionInstruction, Connection, SYSVAR_CLOCK_PUBKEY, ParsedAccountData, Transaction } from "@solana/web3.js";
...
export class VaultImpl implements VaultImplementation {
    ...
    private constructor(connection: Connection, vaultDetails: { vaultParams: VaultParams, program: VaultProgram, vaultPda: PublicKey, tokenVaultPda: PublicKey, vaultState: VaultState }) {
        this.connection = connection;
        this.vaultParams = vaultDetails.vaultParams;
        this.program = vaultDetails.program;
        this.vaultPda = vaultDetails.vaultPda;
        this.tokenVaultPda = vaultDetails.tokenVaultPda;
        this.vaultState = vaultDetails.vaultState;
    }

    public static async create(connection: Connection, vaultParams: VaultParams) {
        ...
        return new VaultImpl(connection, { vaultParams, program, vaultPda, tokenVaultPda, vaultState });
    }
